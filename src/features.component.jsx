        ...
        <div className="flex flex-col space-y-3 text-left md:items-start md:space-y-0 md:space-x-6 md:flex-row">
          ...
          <div>
            ...
            <p className=" text-darkGrayishBlue">
              ...
              consequuntur laudantium assumenda maiores eum quibusdam provident
              laboriosam velit? Quae, dolorum magnam voluptatem sequi beatae
              incidunt tempora voluptas harum consequatur esse.
            </p>
          </div>
        </div>
        {/* List Item */}
